...
const Hero = () => {
  return (
    <section className="font-sans bg-[#1B1714]  items-center lg:items-end justify-center w-full flex">
      <div className="flex flex-col lg:flex-row gap-10 md:gap-16 lg:gap-4 items-center justify-between  text-center lg:text-start px-[2rem] lg:px-[6rem] py-10 lg:my-[4%] w-full">
        <div className="max-w-[820px] ">
          <h1 className="text-[#FFFFFF] md:text-[24px] lg:text-[34px] leading-[20.83px] md:leading-[32.25px] lg:leading-[44.7px] ">PIN Recovery</h1>
