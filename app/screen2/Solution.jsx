...
const Solution = () => {
  return (
    <section className="font-sans px-[2rem] lg:px-[6rem] py-[3rem] lg:py-[5.5rem] bg-[#120F0C] text-[#FFFFFF] flex flex-col xl:flex-row-reverse gap-10 lg:gap-14">
      <Image src={"/Images/b2.png"} width={600} height={600} alt={""} />
